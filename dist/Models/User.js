...
UserSchema.methods.randomCode = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  var code, resetToken, tokenExpire;
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        code = Math.floor(1000 + Math.random() * 9000);
        resetToken = _crypto["default"].createHash('sha256').update(code.toString()).digest('hex');

...
var generateRandomId = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var randomId, existingQuiz;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _mongoose["default"].models.Quiz.findOne({
            _id: randomId
          });
        case 4:
          existingQuiz = _context.sent;
          if (existingQuiz) {
            _context.next = 7;
            break;
          }
...
var QuizSchema = new _mongoose["default"].Schema({
  _id: {
    type: String,
    unique: true
  },
...
QuizSchema.pre("save", /*#__PURE__*/function () {
...
QuizSchema.methods.matchPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(enteredPassword) {
...
var Quiz = _mongoose["default"].model("Quiz", QuizSchema);

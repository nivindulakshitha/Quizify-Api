...
exports["default"] = UserForgotPassword;
var _nodemailer = _interopRequireDefault(require("nodemailer"));
var _User = _interopRequireDefault(require("../Models/User.js"));
var _DatabaseConnectoin = _interopRequireDefault(require("./DatabaseConnectoin.js"));
...
function UserForgotPassword(_x, _x2) {
  return _UserForgotPassword.apply(this, arguments);
}
function _UserForgotPassword() {
  _UserForgotPassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var email, user, code, transport, mailOptions;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 17:
          ...
          console.error("UserForgotPassword:", _context.t0);
        case 21:
        case "end":

...
exports["default"] = QuizCreate;
var _Quiz = _interopRequireDefault(require("../Models/Quiz"));
var _DatabaseConnectoin = _interopRequireDefault(require("./DatabaseConnectoin"));
...
function QuizCreate(_x, _x2) {
  return _QuizCreate.apply(this, arguments);
}
  ...
  _QuizCreate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          quiz = _context.sent;
          quiz.link = "".concat(req.headers.host, "/quiz/").concat(quiz._id);
          _context.next = 10;
          return quiz.save();
        case 10:
          res.status(201).json({
